...
export const COPY_EN: AppCopy = {
  ...
  pipUnsupported: "This browser doesn't support the monitoring window (Chrome 116+).",
  pipMonitorTitle: (title: string) => `Monitor — ${title}`,
  examplesProgressAria: (count: number, min: number) => `${count} of ${min} examples`,
