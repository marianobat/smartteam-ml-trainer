...
export const COPY_ES = {
  ...
  seeUnsure: "No estoy seguro todavía...",
  ...
  pipUnsupported: "Este navegador no soporta la ventana de monitoreo (Chrome 116+).",
  pipMonitorTitle: (title: string) => `Monitoreo — ${title}`,
  examplesProgressAria: (count: number, min: number) => `${count} de ${min} ejemplos`,
